...
<tr><th>',lang(33),'<td><input name="auth[username]" id="username" value="',defined('SS_DATABASE_USERNAME') ? SS_DATABASE_USERNAME : h($_GET["username"]),'" autocapitalize="off">
<tr><th>',lang(34),'<td><input type="password" name="auth[password]" value="',defined('SS_DATABASE_PASSWORD') ? SS_DATABASE_PASSWORD : '','">
...
if(submitBtn && username && username.value) {
	submitBtn.click();
}
</script>
<?php
