<?php
/** Adminer for SilverStripe - loginForm has been replaced so do not replace blindly */
if(!isset($_GET['file'])) {
	...
	if(defined('ADMINER_ACCESS')) {
		...
		if(!defined('ADMINER_AUTOLOGIN')) {
			define('ADMINER_AUTOLOGIN',false);
		}
	}
	else {
...
<tr><th>',lang(31),'<td>',html_select("auth[driver]",$Xb,DRIVER,"loginDriver(this);"),'<tr><th>',lang(32),'<td><input name="auth[server]" value="',defined('SS_DATABASE_SERVER') ? SS_DATABASE_SERVER : h(SERVER),'" title="hostname[:port]" placeholder="localhost" autocapitalize="off">
<tr><th>',lang(33),'<td><input name="auth[username]" id="username" value="',(defined('SS_DATABASE_USERNAME') && ADMINER_AUTOLOGIN) ? SS_DATABASE_USERNAME : h($_GET["username"]),'" autocapitalize="off">
<tr><th>',lang(34),'<td><input type="password" id="password" name="auth[password]" value="',(defined('SS_DATABASE_PASSWORD') && ADMINER_AUTOLOGIN) ? SS_DATABASE_PASSWORD : '','">
<tr><th>',lang(35),'<td><input name="auth[db]" value="',defined('SS_DATABASE_NAME') ? SS_DATABASE_NAME : h($_GET["db"]);?>" autocapitalize="off">
</table>
...
<?php
echo"<p><input type='submit' id='submit-btn' value='".lang(36)."'>\n",checkbox("auth[permanent]",1,$_COOKIE["adminer_permanent"],lang(37))."\n";
?>
<script type="text/javascript">
var submitBtn = document.getElementById('submit-btn');
if(submitBtn && username && username.value && password && password.value) {
	submitBtn.click();
}
</script>
<?php
